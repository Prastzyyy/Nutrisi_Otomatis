...
void mainTask (){
  ...
  if (kondisi1 == true || saklar == true){ //pengganti rtc 
    ...
    gantiSampel();
    kondisiOtomatisasi = "Sedang Berjalan 16,67 %";
    server.handleClient();
    ...
    kontrol_pH();
    kondisiOtomatisasi = "Sedang Berjalan 33,33 %";
    server.handleClient();
    ...
    aktuator4 = "Padam";
    kondisiOtomatisasi = "Sedang Berjalan 66,67 %";
    server.handleClient();
    yield();

    gantiSampel();
    kondisiOtomatisasi = "Sedang Berjalan 83,33%";
    server.handleClient();
    ...
    String sekarang = "JJ:MM:DD";
    kondisiOtomatisasi += sekarang;
    client.publish(PUBTOPIC_STATUS_SISTEM, kondisiOtomatisasi.c_str());
    saklar = false;
  }
  else {
